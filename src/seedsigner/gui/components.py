...
class GUIConstants:
    ...
    BACKGROUND_COLOR = "#6ABA6A"
    INACTIVE_COLOR = "#414141"
    ACCENT_COLOR = "#30D158" # Active Color
    ...
    BUTTON_FONT_COLOR = "#FAFFFA"
    BUTTON_BACKGROUND_COLOR = "#002C00"
    BUTTON_HEIGHT = 32
    BUTTON_SELECTED_FONT_COLOR = "#002C00" #BACKGROUND_COLOR
